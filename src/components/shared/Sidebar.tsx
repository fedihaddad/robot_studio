...
import { DEFAULT_ROSBRIDGE_URL, normalizeRosbridgeUrl } from '../../services/ros-endpoint.service';
...
const navItems: NavItem[] = [
  ...
  { id: 'demo', label: 'Demo Mode', Icon: BoltIcon, page: 9, section: 'Core' },
...
const Sidebar: React.FC<SidebarProps> = ({ 
  ...
  const saveQuickSettings = () => {
    ...
    onConfigChange({
      ...config,
      rosUrl: normalizeRosbridgeUrl(tempRosUrl.trim()),
      cameraUrl: tempCameraUrl.trim(),
    });
      ...
      >
        ...
        <div className="flex items-start justify-between gap-3">
          ...
          <div className="min-w-0">
            ...
            {!isCollapsed && <p className="text-sm axel-muted mt-1">{t('app.subtitle')}</p>}
          </div>
        ...
        <div className={`mt-4 flex flex-col gap-2 ${isCollapsed ? 'items-center' : ''}`}>
          ...
          <div
            ...
            title={rosConnected ? t('sidebar.rosConnected') : t('sidebar.rosDisconnected')}
            style={{
          ...
          >
            ...
            {!isCollapsed && (
              ...
              <span className={rosConnected ? 'text-emerald-600 dark:text-emerald-300' : 'text-rose-600 dark:text-rose-300'}>
                ...
                {rosConnected ? t('sidebar.rosConnected') : t('sidebar.rosDisconnected')}
              </span>
          ...
          <div
            ...
            title={cameraConnected ? t('sidebar.cameraOnline') : t('sidebar.cameraOffline')}
            style={{
          ...
          >
            ...
            {!isCollapsed && (
              ...
              <span className={cameraConnected ? 'text-emerald-600 dark:text-emerald-300' : 'text-rose-600 dark:text-rose-300'}>
                ...
                {cameraConnected ? t('sidebar.cameraOnline') : t('sidebar.cameraOffline')}
              </span>
            ...
            >
              ...
              <div className="p-5 border-b" style={{ borderColor: 'var(--axel-border)' }}>
                ...
                <div className="flex items-center justify-between gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-extrabold" style={{ color: 'var(--axel-text)' }}>{t('common.quickSettings')}</p>
                    <p className="text-xs axel-muted mt-0.5">{t('sidebar.quickSettingsSubtitle')}</p>
                  </div>
              ...
              <div className="p-5 space-y-4">
                ...
                <div>
                  ...
                  <label className="block text-[11px] font-extrabold axel-muted mb-1">{t('sidebar.rosUrl')}</label>
                  <input
                ...
                <div>
                  ...
                  <label className="block text-[11px] font-extrabold axel-muted mb-1">{t('sidebar.cameraUrl')}</label>
                  <input
                    ...
                    placeholder="http://axel.local:8000/?action=stream"
          ...
          <div key={section} className="space-y-2">
            ...
            {!isCollapsed && (
              ...
              <p className="text-[10px] uppercase tracking-widest axel-muted px-2">
                ...
                {t(`nav.section.${section.toLowerCase()}`, section)}
              </p>
            ...
            {items.map((item) => {
              ...
              return (
                ...
                <button
                  ...
                  title={isCollapsed ? t(`nav.${item.id}`, item.label) : undefined}
                  className={[
